...
(function($) {
    ...
    // dwright
    // My Mod: I wrap the entire bootstrap3_player code in a 'bootAudio' method
    // so that this would work on dynamicly created elements (jquery)
    // $("<audio/>", {
    //            "id": data.id,
    //            controls: "controls",
